...
exports.sendMail = async function ({ to, subject, text, html }) {
  ...
  const info = await transporter.sendMail({
    from: '"Systummm 🛒" <kashifjsr7@gmail.com>', // sender address
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                <img src="https://raw.githubusercontent.com/kashif2666/MERNStack-Ecommerce/df0099e87d50315692f6132fcc9a4dee265176b2/public/logo4.png" alt="Logo" border="0" width="48" style="display: block; width: 200px; max-width: 200px; min-width: 200px;">
              </a>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="kashifjsr7@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
